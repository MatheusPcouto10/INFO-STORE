...
namespace AvaliacaoA1.View
{
    public partial class FormPesquisaFornecedor : Form
    {
        ...
        private void dgPesquisa_Fornecedores_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (formAtual == "filtroRelatorioEntradas")
            {
                (Application.OpenForms["FiltroRelatorioEntradas"].Controls["txtIdFornecedor"] as TextBox).Text = txtIdFornecedor.Text;
                (Application.OpenForms["FiltroRelatorioEntradas"].Controls["txtNomeFantasia"] as TextBox).Text = txtNomeFantasia.Text;
                this.Hide();
            }
            else if (formAtual == "filtroRelatorioRetiradas")
            {
                (Application.OpenForms["FiltroRelatorioRetiradas"].Controls["txtIdFornecedor"] as TextBox).Text = txtIdFornecedor.Text;
                (Application.OpenForms["FiltroRelatorioRetiradas"].Controls["txtNomeFantasia"] as TextBox).Text = txtNomeFantasia.Text;
                this.Hide();
            }
        }
