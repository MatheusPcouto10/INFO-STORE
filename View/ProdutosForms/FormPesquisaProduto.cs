...
namespace AvaliacaoA1.View
{
    public partial class FormPesquisaProduto : Form
    {
        ...
        private void dgPesquisa_Produtos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                (Application.OpenForms["FiltroRelatorioEntradas"].Controls["txtIdProduto"] as TextBox).Text = txtIdProduto.Text;
                (Application.OpenForms["FiltroRelatorioEntradas"].Controls["txtNomeProduto"] as TextBox).Text = txtNomeProduto.Text;
                this.Hide();
            }
            else if (formAtual == "filtroRelatorioRetiradas")
            {
                (Application.OpenForms["FiltroRelatorioRetiradas"].Controls["txtIdProduto"] as TextBox).Text = txtIdProduto.Text;
                (Application.OpenForms["FiltroRelatorioRetiradas"].Controls["txtNomeProduto"] as TextBox).Text = txtNomeProduto.Text;
                this.Hide();
            }
        }
